...
class Publisher:
    def __init__(self, publisher_name: str):
        if publisher_name == "" or not isinstance(publisher_name, str):
    ...
    def publisher_name(self, new_name: str):
        if new_name == "" or not isinstance(new_name, str):
            self.__publisher_name = None
        else:
            self.__publisher_name = new_name.strip()
...
class Game:
    def __init__(self, game_id: int, game_title: str):
        ...
        # self.__screenshots = [] # need to change logic from list into string of languages
        self.__screenshots = None
        self.__languages = None # need to change logic from list into string of languages
        ...
        self.__movie_url = None
        self.__player_modes = None
    ...
    @screenshots.setter
    def screenshots(self, screenshots: str):
        if isinstance(screenshots, str) and screenshots.strip() != "":
    ...
    @windows.setter
    def windows(self, support: bool):
        if isinstance(support, bool):
            self.__windows = support
        else:
            raise ValueError("Windows support must be a boolean value")
    ...
    @mac.setter
    def mac(self, support: bool):
        if isinstance(support, bool):
            self.__mac = support
        else:
            raise ValueError("Mac support must be a boolean value")
    ...
    @linux.setter
    def linux(self, support: bool):
        if isinstance(support, bool):
            self.__linux = support
        else:
            raise ValueError("Linux support must be a boolean value")
    # end of for gameDesc data
    ...
    def movie_url(self, movie_url: str):
        if isinstance(movie_url, str) and movie_url.strip() != "":
    ...
    def genre_names(self):
        # Return a list of genre names from the genres attribute
        return [genre.genre_name for genre in self.__genres]

    @property
    def player_modes(self):
        return self.__player_modes

    @player_modes.setter
    def player_modes(self, player_modes: str):
        if isinstance(player_modes, str) and player_modes.strip() != "":
            self.__player_modes = player_modes
        else:
            self.__player_modes = None
    ...
    @developers.setter
    def developers(self, developers: str):
        if isinstance(developers, str) and developers.strip() != "":
   ...
   #@property
    ...
    #    if self.__publisher:
    #        return self.__publisher.publisher_name
     #   else:
    #        return None
